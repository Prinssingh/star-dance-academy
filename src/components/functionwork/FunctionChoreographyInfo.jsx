      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            {/* Description */}
            <div
              className="space-y-4 text-base md:text-base leading-relaxed"
              style={{ color: "var(--color-elegantDark)" }}
            >
              <p>
                ...
                for all your wedding celebrations. From the vibrant energy of{" "}
                <span
                  className="font-semibold"
                  style={{ color: "var(--color-secondary)" }}
                >
              ...
              <p>
                Our expertise includes choreographing stunning performances for{" "}
                <span
                  className="font-semibold"
                  style={{ color: "var(--color-secondary)" }}
                >
