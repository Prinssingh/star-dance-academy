          ...
          <div className="flex items-center justify-between h-20">
            ...
            >
              ...
              <motion.h1
                ...
                className="text-2xl md:text-3xl font-serif font-bold bg-linear-to-r from-primary to-secondary bg-clip-text text-transparent"
              >
                Star Dance Academy
              </motion.h1>
            </div>
        ...
        "
              >
                ...
                <div className="absolute top-5 right-5 left-5 flex items-center justify-between z-20">
                  ...
                  <button
                    onClick={() => handleLinkClick("/")}
                    className="flex items-center gap-2 w-9 h-9 bg-black rounded-full "
                  >
                    
                    <img
                      src="/logo.png" // <-- apna logo path
                      alt="Logo"
                      className="w-fukk h-fukk  rounded-lg object-cover  p-1"
                    />
                  </button>
            ...
            "
                  ...
                  <div className="mt-10 space-y-2 text-white/80 text-sm">
                    ...
                    <Link
                      href={"tel:+91 6264249659"}
                      className="flex items-center gap-2"
                    >
                      <Phone size={15} /> +91 6264249659
                    </Link>
                  </div>
                </div>
              </motion.div>
