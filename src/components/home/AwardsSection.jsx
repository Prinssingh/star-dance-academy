  ...
  const awards = [
    {
      ...
      organization: "Soul of Dance Inner-State Championship",
       image:"/assets/awards/award001.png",
      description:
        "Huge congratulations! Taking home the top spot is an incredible achievement—all those hours of practice and your pure passion truly shone through on that stage.",
    },
    {
      year: "2024",
      title: "Ultimate Dance Champion",
      organization: "Ultimate Dance Championship, Jabalpur MP",
      description:
        "A massive win for the books! All that hard work and heart you poured into your performance really paid off—you truly owned the stage in Madhya Pradesh.",
    },
    {
      year: "2024",
      title: "Winner",
      organization: "Vindhya Championship, Rewa MP",
      description:
        "An incredible milestone right here in MP. You brought so much energy and talent to the stage, and this victory is a testament to your amazing dedication.",
    },
  ];
