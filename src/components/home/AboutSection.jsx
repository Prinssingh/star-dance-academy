    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 lg:px-12 py-20 lg:py-20">
        ...
        >
          ...
          >
            About{" "}
            <span style={{ color: "var(--color-primary)" }}>Our Academy</span>
          </h2>

          <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
            Experience the perfect blend of expert training, personalized
            attention, and world-class facilities that make us the premier
            choice for dance enthusiasts.
          </p>
        </motion.div>
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
              ...
              >
                ...
                <span className="relative inline-block mt-1">
                  ...
                  <motion.span
                    ...
                    className="absolute -bottom-2 left-0 h-0.75 bg-linear-to-r from-primary via-secondary to-primary rounded-full"
                  />
                </span>
              </h2>
            </motion.div>
            ...
            <motion.div variants={textItemVariants} className="space-y-6 pt-4">
              <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
                For over a decade, we've been crafting moments that transcend
                movement. Each step, each turn, each expression—meticulously
                designed to transform hesitation into confidence, and dreams
                into unforgettable performances.
              </p>

              <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
                Our academy isn't just a space to learn choreography. It's where
                souls discover their rhythm, where couples find their first
                dance, and where celebration becomes an art form. This is the
                alchemy of dance—where discipline meets emotion.
              </p>

              <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
                From classical grace to contemporary fire, from Zumba energy to
                wedding elegance, we don't teach steps. We curate experiences,
                build memories, and celebrate the extraordinary within you.
              </p>
            </motion.div>
